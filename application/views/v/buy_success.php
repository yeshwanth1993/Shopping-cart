...
<div class="container-fluid">
    <div class="row">
            <div class="panel panel-default ">
                ...
                <br> <br>
                <p>If you have signed in as a guest, we will send you the details of where your order will be shipped from, via E-mail and you can contact that particular branch to know the status. </p>
                </div>
